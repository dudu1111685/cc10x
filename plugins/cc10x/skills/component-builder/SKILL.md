...
This skill is the Codex-compatible form of the original Claude Code `component-builder` specialist agent. Use it under `cc10x-router` orchestration or when explicitly asked to perform this specialist workflow role.
